...
public class ArticleListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(ArticleListActivity.this);
        ...
        listView.addItemDecoration(
                new DividerItemDecoration(ArticleListActivity.this, DividerItemDecoration.VERTICAL));
